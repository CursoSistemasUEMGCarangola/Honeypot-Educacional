🎣 Comunicado: Projeto Honeypot Educacional e Conscientização em Cibersegurança

De:  Alunos do 3º Período de Sistemas de Informação
...
Durante o período ativo da simulação, ao submeter o formulário:
...
•	Um vídeo educativo de conscientização, gravado com a participação dos alunos do 3º Período do curso de Sistemas de Informação, detalhando o funcionamento do teste.
•	As estatísticas gerais e o ranking de cliques por curso.
•	Instruções didáticas ensinando os discentes a reconhecerem phishing no futuro (pressão por urgência, domínios falsos e fontes não oficiais).
...
[IMPORTANTE] Nenhum dado pessoal foi trafegado ou armazenado.
...
O código-fonte do projeto pode ser acessado e auditado em https://github.com/CursoSistemasUEMGCarangola/Honeypot-Educacional
...
Taxa de Vulnerabilidade: 0.0%: O curso de Serviço Social destacou-se de maneira excepcional, sendo o único curso cadastrado que registrou zero submissões durante toda a campanha. Isso sinaliza um comportamento exemplar de prevenção, desconfiança saudável em relação a ofertas suspeitas e alto discernimento sobre links externos. Parabéns aos envolvidos pelo ótimo hábito de segurança digital!
...
Turma do 3º Período de Sistemas de Informação
